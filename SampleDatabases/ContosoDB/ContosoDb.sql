...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'ContosoDB')
BEGIN
	ALTER DATABASE [ContosoDB] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [ContosoDB] SET ONLINE;
