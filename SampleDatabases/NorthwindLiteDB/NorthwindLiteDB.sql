...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'NorthwinLiteDB')
BEGIN
	ALTER DATABASE [NorthwinLiteDB] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [NorthwinLiteDB] SET ONLINE;
	DROP DATABASE [NorthwinLiteDB];
END
...
/*******************************************************************************
   Create database
********************************************************************************/
CREATE DATABASE [NorthwinLiteDB];
GO
